class Bsh < Formula
  ...
  url "https://github.com/Digital-Defiance/bsh/archive/refs/tags/bsh-5.9.0.9.tar.gz"
  sha256 "cca573393179ed89b482b4350e03d9d4b76bb0334607a3f2df0110096fa2972f"
  version "5.9.0.9"
  license "MIT"
  ...
  test do
    assert_match "5.9.0.9", shell_output("#{bin}/bsh --version")
