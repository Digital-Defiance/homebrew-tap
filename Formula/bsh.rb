class Bsh < Formula
  ...
  url "https://github.com/Digital-Defiance/bsh/archive/refs/tags/bsh-5.9.0.10.tar.gz"
  sha256 "b632fd1c5fa8e42c5e13d8f8de54f090c5949c4288a84d40e5ca504570154a15"
  version "5.9.0.10"
  license "MIT"
  ...
  test do
    assert_match "5.9.0.10", shell_output("#{bin}/bsh --version")
